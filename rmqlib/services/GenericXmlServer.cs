...
{
    public GenericXmlServer(string? hostname, string exchange, string user,Action<string>? notificationAction=null) : base(hostname, exchange, user,notificationAction)
    {
    }
    ...
    protected override GenericResponse Process(GenericRequest request)
    {
        ...
        {
            throw new Exception("Invalid message 9999");
        }
